...
Anchor the streamer’s status bar to the top safe area and its persistent action bar to the bottom safe area. Keep chat in the bottom dock directly above the action bar so messages grow upward without changing the controls’ bottom position.

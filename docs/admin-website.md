...
- Browser coverage adds real-value/zero/error overview fixtures, chart daily-count access, account-table isolation, retry, cleared metrics on permission loss, and desktop/phone layout. These fixtures test rendering separately from the database aggregate tests; they do not sign in as the owner.

  ...
  return <Modal visible transparent animationType="slide" onRequestClose={close} statusBarTranslucent>
    <View style={{ flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.55)" }}>
      <View style={{ backgroundColor: "#17171D", borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, paddingBottom: insets.bottom + 20, maxHeight: "85%" }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}><Text style={[localizedTextStyle(), { color: "#FFF", fontSize: 22, fontWeight: "700" }]}>{messageId ? t("Report message") : t("Report user")}</Text><TouchableOpacity onPress={close} disabled={mutation.isPending} accessibilityLabel={t("Close")}><Ionicons name="close" size={24} color="#FFF" /></TouchableOpacity></View>

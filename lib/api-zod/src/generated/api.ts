 ...
 */
export const getDmConversationQueryLimitDefault = 50;

export const GetDmConversationQueryParams = zod.object({
  "fromUid": zod.coerce.number(),
  "toUid": zod.coerce.number(),
  "limit": zod.coerce.number().default(getDmConversationQueryLimitDefault)
})

export const GetDmConversationResponse = zod.object({
  "messages": zod.array(zod.object({
  "id": zod.number(),
  "fromUserId": zod.number(),
  "toUserId": zod.number(),
